...
Past Surgeries: ${formData.pastSurgeries || "None reported"}

SYMPTOMS & LIFESTYLE:
Symptoms: ${formData.symptoms || "None reported"}
Exercise Habits: ${formData.exercise || "Not specified"}
Smoking History: ${formData.smoking || "Not specified"}
Alcohol Consumption: ${formData.alcohol || "Not specified"}

AI ANALYSIS RESULTS:
${analysis}

Generated by CardioAI Screening System - ${new Date().toISOString()}
    `;
    ...
    a.href = url;
    a.download = `${formData.name || "Patient"}_SHD_Report_${new Date().toISOString().split("T")[0]}.txt`;
