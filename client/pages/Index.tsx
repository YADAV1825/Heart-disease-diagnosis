...
export default function Index() {
  ...
  const generatePDF = async () => {
    ...
    // Title
    doc.setFontSize(20);
    doc.setTextColor(0, 139, 139); // Medical teal color
    doc.text("CardioAI Screening Report", 20, 30);

    // Subtitle
    doc.setFontSize(12);
    doc.setTextColor(100, 100, 100);
    doc.text("Structural Heart Disease Analysis", 20, 40);
    ...
    doc.setFontSize(14);
    doc.setTextColor(0, 0, 0);
    doc.text("AI Analysis Results:", 20, yPosition + 15);
